...
if __name__ == '__main__':
    ...
    user_tasks_url = 'https://jsonplaceholder.typicode.com/todos?userId={}'.format(user_id)
    ...
    with open('{}.csv'.format(user_id), 'w', encoding='UTF8', newline='') as csv_file:
        ...
        for task in user_tasks:
            ...
            csv_writer.writerow([user_id, user_username, task_completed, task_title])
